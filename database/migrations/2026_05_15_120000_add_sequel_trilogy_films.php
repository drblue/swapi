...
class AddSequelTrilogyFilms extends Migration
{
	...
	private function people()
	{
		...
		return [
			$this->person(84, 'Rey', '15ABY', 'hazel', 'brown', '170', '54', 'light', 61, ['Resistance', 'Jedi Order'], 'https://starwars.fandom.com/wiki/Rey_Skywalker'),
			$this->person(85, 'Finn', '11ABY', 'dark', 'black', '178', '73', 'dark', 28, ['First Order', 'Resistance'], 'https://starwars.fandom.com/wiki/Finn'),
			$this->person(86, 'Poe Dameron', '2ABY', 'brown', 'brown', '172', '80', 'light', 72, ['New Republic', 'Resistance'], 'https://starwars.fandom.com/wiki/Poe_Dameron'),
			$this->person(87, 'BB-8', 'unknown', 'black', 'none', '67', '18', 'white, orange', null, ['Resistance'], 'https://starwars.fandom.com/wiki/BB-8'),
			$this->person(88, 'Kylo Ren', '5ABY', 'brown', 'black', '189', '89', 'light', 2, ['New Jedi Order', 'Knights of Ren', 'First Order'], 'https://starwars.fandom.com/wiki/Ben_Solo'),
			$this->person(89, 'Snoke', 'unknown', 'blue', 'none', '218', 'unknown', 'pale', 67, ['First Order'], 'https://starwars.fandom.com/wiki/Snoke'),
			$this->person(90, 'Maz Kanata', '973BBY', 'yellow', 'white', '124', 'unknown', 'orange', 63, ['Maz Kanata\'s castle', 'Resistance'], 'https://starwars.fandom.com/wiki/Maz_Kanata'),
			$this->person(91, 'General Hux', '0ABY', 'blue', 'red', '185', 'unknown', 'light', 28, ['First Order'], 'https://starwars.fandom.com/wiki/Armitage_Hux'),
			$this->person(92, 'Captain Phasma', 'unknown', 'blue', 'blonde', '200', 'unknown', 'light', 28, ['First Order'], 'https://starwars.fandom.com/wiki/Phasma'),
			$this->person(93, 'Rose Tico', 'unknown', 'brown', 'black', '160', 'unknown', 'light', 28, ['Resistance'], 'https://starwars.fandom.com/wiki/Rose_Tico'),
			$this->person(94, 'Vice Admiral Holdo', 'unknown', 'blue', 'purple', '170', 'unknown', 'light', 28, ['Resistance'], 'https://starwars.fandom.com/wiki/Amilyn_Holdo'),
			$this->person(95, 'DJ', 'unknown', 'brown', 'black', '180', 'unknown', 'light', 28, [], 'https://starwars.fandom.com/wiki/DJ'),
			$this->person(96, 'Jannah', 'unknown', 'brown', 'black', '170', 'unknown', 'dark', 71, ['First Order', 'Company 77', 'Resistance'], 'https://starwars.fandom.com/wiki/Jannah'),
			$this->person(97, 'Zorii Bliss', 'unknown', 'unknown', 'unknown', '170', 'unknown', 'unknown', 69, ['Spice Runners of Kijimi'], 'https://starwars.fandom.com/wiki/Zorii_Bliss'),
			$this->person(98, 'D-O', 'unknown', 'black', 'none', 'unknown', 'unknown', 'white, green', null, ['Resistance'], 'https://starwars.fandom.com/wiki/D-O'),
			$this->person(99, 'Lor San Tekka', 'unknown', 'blue', 'white', 'unknown', 'unknown', 'light', 61, ['Church of the Force'], 'https://starwars.fandom.com/wiki/Lor_San_Tekka'),
			$this->person(100, 'Unkar Plutt', 'unknown', 'black', 'none', 'unknown', 'unknown', 'green', 61, ['Niima Outpost'], 'https://starwars.fandom.com/wiki/Unkar_Plutt'),
			$this->person(101, 'Teedo', 'unknown', 'black', 'none', 'unknown', 'unknown', 'unknown', 61, [], 'https://starwars.fandom.com/wiki/Teedo'),
			$this->person(102, 'Snap Wexley', 'unknown', 'brown', 'brown', 'unknown', 'unknown', 'light', 28, ['New Republic', 'Resistance'], 'https://starwars.fandom.com/wiki/Temmin_Wexley'),
			$this->person(103, 'Lieutenant Connix', 'unknown', 'blue', 'brown', 'unknown', 'unknown', 'light', 28, ['Resistance'], 'https://starwars.fandom.com/wiki/Kaydel_Ko_Connix'),
			$this->person(104, 'Commander D\'Acy', 'unknown', 'brown', 'brown', 'unknown', 'unknown', 'light', 28, ['Resistance'], 'https://starwars.fandom.com/wiki/Larma_D\'Acy'),
			$this->person(105, 'Allegiant General Pryde', 'unknown', 'blue', 'grey', 'unknown', 'unknown', 'light', 28, ['First Order', 'Final Order'], 'https://starwars.fandom.com/wiki/Enric_Pryde'),
			$this->person(106, 'Beaumont Kin', 'unknown', 'brown', 'brown', 'unknown', 'unknown', 'light', 28, ['Resistance'], 'https://starwars.fandom.com/wiki/Beaumont_Kin'),
			$this->person(107, 'Babu Frik', 'unknown', 'black', 'white', 'unknown', 'unknown', 'tan', 69, ['Anzellan droidsmiths'], 'https://starwars.fandom.com/wiki/Babu_Frik'),
			$this->person(108, 'Klaud', 'unknown', 'black', 'none', 'unknown', 'unknown', 'green', 28, ['Resistance'], 'https://starwars.fandom.com/wiki/Klaud'),
		];
	}

	private function person($id, $name, $birthYear, $eyeColor, $hairColor, $height, $mass, $skinColor, $homeworldId, array $affiliations, $wikiLink)
	{
		$timestamp = $this->timestamp();
