...
#
# Host: 127.0.0.1 (MySQL 5.7.33-0ubuntu0.16.04.1)
# Database: swapi
# Generation Time: 2026-04-26 15:17:55 +0000
# ************************************************************
...
INSERT INTO `film_person` (`id`, `film_id`, `person_id`)
VALUES
	(1,1,1),
	(2,2,1),
	(3,3,1),
...
INSERT INTO `film_planet` (`id`, `film_id`, `planet_id`)
VALUES
	(1,1,1),
	(2,3,1),
	(3,4,1),
...
INSERT INTO `film_species` (`id`, `film_id`, `species_id`)
VALUES
	(1,1,1),
	(2,2,1),
	(3,3,1),
...
INSERT INTO `film_starship` (`id`, `film_id`, `starship_id`)
VALUES
	(1,1,2),
	(2,3,2),
	(3,6,2),
...
INSERT INTO `film_vehicle` (`id`, `film_id`, `vehicle_id`)
VALUES
	(1,1,4),
	(2,5,4),
	(3,1,6),
...
CREATE TABLE `films` (
  ...
  `episode_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `films` (`id`, `title`, `episode_id`, `opening_crawl`, `director`, `producer`, `release_date`, `image_url`, `created`, `edited`)
VALUES
	(1,'A New Hope','4','It is a period of civil war.\r\nRebel spaceships, striking\r\nfrom a hidden base, have won\r\ntheir first victory against\r\nthe evil Galactic Empire.\r\n\r\nDuring the battle, Rebel\r\nspies managed to steal secret\r\nplans to the Empire\'s\r\nultimate weapon, the DEATH\r\nSTAR, an armored space\r\nstation with enough power\r\nto destroy an entire planet.\r\n\r\nPursued by the Empire\'s\r\nsinister agents, Princess\r\nLeia races home aboard her\r\nstarship, custodian of the\r\nstolen plans that can save her\r\npeople and restore\r\nfreedom to the galaxy....','George Lucas','Gary Kurtz, Rick McCallum','1977-05-25','https://www.themoviedb.org/t/p/w1280/6FfCtAuVAW8XJjZ7eWeLibRLWTw.jpg','2014-12-10T14:23:31.880000Z','2014-12-20T19:49:45.256000Z'),
	(2,'The Empire Strikes Back','5','It is a dark time for the\r\nRebellion. Although the Death\r\nStar has been destroyed,\r\nImperial troops have driven the\r\nRebel forces from their hidden\r\nbase and pursued them across\r\nthe galaxy.\r\n\r\nEvading the dreaded Imperial\r\nStarfleet, a group of freedom\r\nfighters led by Luke Skywalker\r\nhas established a new secret\r\nbase on the remote ice world\r\nof Hoth.\r\n\r\nThe evil lord Darth Vader,\r\nobsessed with finding young\r\nSkywalker, has dispatched\r\nthousands of remote probes into\r\nthe far reaches of space....','Irvin Kershner','Gary Kurtz, Rick McCallum','1980-05-17','https://www.themoviedb.org/t/p/w1280/nNAeTmF4CtdSgMDplXTDPOpYzsX.jpg','2014-12-12T11:26:24.656000Z','2014-12-15T13:07:53.386000Z'),
	(3,'Return of the Jedi','6','Luke Skywalker has returned to\r\nhis home planet of Tatooine in\r\nan attempt to rescue his\r\nfriend Han Solo from the\r\nclutches of the vile gangster\r\nJabba the Hutt.\r\n\r\nLittle does Luke know that the\r\nGALACTIC EMPIRE has secretly\r\nbegun construction on a new\r\narmored space station even\r\nmore powerful than the first\r\ndreaded Death Star.\r\n\r\nWhen completed, this ultimate\r\nweapon will spell certain doom\r\nfor the small band of rebels\r\nstruggling to restore freedom\r\nto the galaxy...','Richard Marquand','Howard G. Kazanjian, George Lucas, Rick McCallum','1983-05-25','https://www.themoviedb.org/t/p/w1280/jQYlydvHm3kUix1f8prMucrplhm.jpg','2014-12-18T10:39:33.255000Z','2014-12-20T09:48:37.462000Z'),
	(4,'The Phantom Menace','1','Turmoil has engulfed the\r\nGalactic Republic. The taxation\r\nof trade routes to outlying star\r\nsystems is in dispute.\r\n\r\nHoping to resolve the matter\r\nwith a blockade of deadly\r\nbattleships, the greedy Trade\r\nFederation has stopped all\r\nshipping to the small planet\r\nof Naboo.\r\n\r\nWhile the Congress of the\r\nRepublic endlessly debates\r\nthis alarming chain of events,\r\nthe Supreme Chancellor has\r\nsecretly dispatched two Jedi\r\nKnights, the guardians of\r\npeace and justice in the\r\ngalaxy, to settle the conflict....','George Lucas','Rick McCallum','1999-05-19','https://www.themoviedb.org/t/p/w1280/6wkfovpn7Eq8dYNKaG5PY3q2oq6.jpg','2014-12-19T16:52:55.740000Z','2014-12-20T10:54:07.216000Z'),
	(5,'Attack of the Clones','2','There is unrest in the Galactic\r\nSenate. Several thousand solar\r\nsystems have declared their\r\nintentions to leave the Republic.\r\n\r\nThis separatist movement,\r\nunder the leadership of the\r\nmysterious Count Dooku, has\r\nmade it difficult for the limited\r\nnumber of Jedi Knights to maintain \r\npeace and order in the galaxy.\r\n\r\nSenator Amidala, the former\r\nQueen of Naboo, is returning\r\nto the Galactic Senate to vote\r\non the critical issue of creating\r\nan ARMY OF THE REPUBLIC\r\nto assist the overwhelmed\r\nJedi....','George Lucas','Rick McCallum','2002-05-16','https://www.themoviedb.org/t/p/w1280/oZNPzxqM2s5DyVWab09NTQScDQt.jpg','2014-12-20T10:57:57.886000Z','2014-12-20T20:18:48.516000Z'),
	(6,'Revenge of the Sith','3','War! The Republic is crumbling\r\nunder attacks by the ruthless\r\nSith Lord, Count Dooku.\r\nThere are heroes on both sides.\r\nEvil is everywhere.\r\n\r\nIn a stunning move, the\r\nfiendish droid leader, General\r\nGrievous, has swept into the\r\nRepublic capital and kidnapped\r\nChancellor Palpatine, leader of\r\nthe Galactic Senate.\r\n\r\nAs the Separatist Droid Army\r\nattempts to flee the besieged\r\ncapital with their valuable\r\nhostage, two Jedi Knights lead a\r\ndesperate mission to rescue the\r\ncaptive Chancellor....','George Lucas','Rick McCallum','2005-05-19','https://www.themoviedb.org/t/p/w1280/xfSAoBEm9MNBjmlNcDYLvLSMlnq.jpg','2014-12-20T18:49:38.403000Z','2014-12-20T20:47:52.073000Z');
...
VALUES
	...
	(24,'2024_05_19_122147_alter_people_add_link_image_affiliations',4),
	(25,'2024_05_19_124615_alter_films_add_image_url',5);
...
CREATE TABLE `people` (
  ...
  `image_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `affiliations` longtext COLLATE utf8mb4_unicode_ci,
  `created` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `edited` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `people` (`id`, `name`, `birth_year`, `eye_color`, `hair_color`, `height`, `mass`, `skin_color`, `wiki_link`, `image_url`, `affiliations`, `created`, `edited`, `homeworld_id`)
VALUES
	(1,'Luke Skywalker','19BBY','blue','blond','172','77','fair','https://starwars.wikia.com/wiki/Luke_Skywalker','https://vignette.wikia.nocookie.net/starwars/images/2/20/LukeTLJ.jpg','[\"Alliance to Restore the Republic\",\"Red Squadron\",\"Rogue Squadron\",\"Massassi Group\",\"Leia Organa\'s team\",\"Endor strike team\",\"Jedi Order\",\"Bright Tree tribe\",\"New Republic\",\"Resistance\"]','2014-12-09T13:50:51.644000Z','2014-12-20T21:17:56.891000Z',1),
	(2,'C-3PO','112BBY','yellow','n/a','167','75','gold','https://starwars.wikia.com/wiki/C-3PO','https://vignette.wikia.nocookie.net/starwars/images/3/3f/C-3PO_TLJ_Card_Trader_Award_Card.png','[\"Skywalker family\",\"Confederacy of Independent Systems\",\"Royal House of Naboo\",\"Galactic Republic\",\"House of Organa\",\"Galactic Empire\",\"Alliance to Restore the Republic\",\"Massassi Group\",\"Leia Organa\'s team\",\"Pathfinders\",\"Endor strike team\",\"Bright Tree tribe\",\"New Republic\",\"Resistance\",\"Resistance spy droid network\"]','2014-12-10T15:10:51.357000Z','2014-12-20T21:17:50.309000Z',1),
	(3,'R2-D2','33BBY','red','n/a','96','32','white, blue','https://starwars.wikia.com/wiki/R2-D2','https://vignette.wikia.nocookie.net/starwars/images/e/eb/ArtooTFA2-Fathead.png','[\"Royal House of Naboo\",\"Galactic Republic\",\"501st Legion\",\"R2-D2\'s battle droid squadron\",\"D-Squad\",\"House of Organa\",\"Galactic Empire\",\"Alliance to Restore the Republic\",\"Massassi Group\",\"Red Squadron\",\"Leia Organa\'s team\",\"Endor strike team\",\"Bright Tree tribe\",\"Resistance\"]','2014-12-10T15:11:50.376000Z','2014-12-20T21:17:50.311000Z',8),
	(4,'Darth Vader','41.9BBY','yellow','none','202','136','white','https://starwars.wikia.com/wiki/Anakin_Skywalker','https://vignette.wikia.nocookie.net/fr.starwars/images/3/32/Dark_Vador.jpg','[\"501st Legion\",\"Sith\",\"Galactic Empire\",\"Imperial High Command\"]','2014-12-10T15:18:20.704000Z','2014-12-20T21:17:50.313000Z',1),
	(5,'Leia Organa','19BBY','brown','brown','150','49','light','https://starwars.wikia.com/wiki/Leia_Organa','https://vignette.wikia.nocookie.net/starwars/images/f/fc/Leia_Organa_TLJ.png','[\"Elder Houses\",\"House of Organa\",\"Galactic Empire\",\"Imperial Senate\",\"Alliance to Restore the Republic\",\"Massassi Group\",\"Leia Organa\'s team\",\"Endor strike team\",\"Alliance High Command\",\"Bright Tree tribe\",\"New Republic\",\"Populists\",\"Resistance\"]','2014-12-10T15:20:09.791000Z','2014-12-20T21:17:50.315000Z',2),
	(6,'Owen Lars','52BBY','blue','brown, grey','178','120','light','https://starwars.wikia.com/wiki/Owen_Lars','https://vignette.wikia.nocookie.net/starwars/images/e/eb/OwenCardTrader.png','[\"Lars family\"]','2014-12-10T15:52:14.024000Z','2014-12-20T21:17:50.317000Z',1),
	(7,'Beru Whitesun lars','47BBY','blue','brown','165','75','light','https://starwars.wikia.com/wiki/Beru_Whitesun_Lars','https://vignette.wikia.nocookie.net/starwars/images/c/cc/BeruCardTrader.png','[]','2014-12-10T15:53:41.121000Z','2014-12-20T21:17:50.319000Z',1),
	(8,'R5-D4','unknown','red','n/a','97','32','white, red','https://starwars.wikia.com/wiki/R5-D4','https://vignette.wikia.nocookie.net/starwars/images/c/cb/R5-D4_Sideshow.png','[\"Alliance to Restore the Republic\"]','2014-12-10T15:57:50.959000Z','2014-12-20T21:17:50.321000Z',1),
	(9,'Biggs Darklighter','24BBY','brown','black','183','84','light','https://starwars.wikia.com/wiki/Biggs_Darklighter','https://vignette.wikia.nocookie.net/starwars/images/0/00/BiggsHS-ANH.png','[\"Galactic Empire\",\"Prefsbelt Fleet Camp\",\"Alliance to Restore the Republic\",\"Red Squadron\",\"Massassi Group\"]','2014-12-10T15:59:50.509000Z','2014-12-20T21:17:50.323000Z',1),
	(10,'Obi-Wan Kenobi','57BBY','blue-gray','auburn, white','182','77','fair','https://starwars.wikia.com/wiki/Obi-Wan_Kenobi','https://vignette.wikia.nocookie.net/starwars/images/4/4e/ObiWanHS-SWE.jpg','[\"Jedi Order\",\"Jedi High Council\",\"Galactic Republic\",\"212th Attack Battalion\",\"Alliance to Restore the Republic\"]','2014-12-10T16:16:29.192000Z','2014-12-20T21:17:50.325000Z',20),
	(11,'Anakin Skywalker','41.9BBY','blue','blond','188','84','fair','https://starwars.wikia.com/wiki/Anakin_Skywalker','https://vignette.wikia.nocookie.net/starwars/images/6/6f/Anakin_Skywalker_RotS.png','[\"501st Legion\",\"Sith\",\"Galactic Empire\",\"Imperial High Command\"]','2014-12-10T16:20:44.310000Z','2014-12-20T21:17:50.327000Z',1),
	(12,'Wilhuff Tarkin','64BBY','blue','auburn, grey','180','unknown','fair','https://starwars.wikia.com/wiki/Wilhuff_Tarkin','https://vignette.wikia.nocookie.net/starwars/images/c/c1/Tarkininfobox.jpg','[\"Galactic Republic\",\"Sullust Sector Spacefarers Academy\",\"Judicial Forces\",\"Republic Navy\",\"Strategic Advisory Cell\",\"Outland Regions Security Force\",\"Outland\'s anti-pirate taskforce\",\"Galactic Empire\",\"Battle Station Command\",\"Imperial Officer Corps\",\"Imperial Navy\",\"Tarkin Initiative\"]','2014-12-10T16:26:56.138000Z','2014-12-20T21:17:50.330000Z',21),
	(13,'Chewbacca','200BBY','blue','brown','228','112','unknown','https://starwars.wikia.com/wiki/Chewbacca','https://vignette.wikia.nocookie.net/starwars/images/4/48/Chewbacca_TLJ.png','[\"Galactic Republic\",\"Alliance to Restore the Republic\",\"Leia Organa\'s team\",\"Pathfinders\",\"Endor strike team\",\"Bright Tree tribe\",\"New Republic\",\"Resistance\"]','2014-12-10T16:42:45.066000Z','2014-12-20T21:17:50.332000Z',14),
	(14,'Han Solo','29BBY','brown','brown','180','80','fair','https://starwars.wikia.com/wiki/Han_Solo','https://vignette.wikia.nocookie.net/starwars/images/e/e2/TFAHanSolo.png','[\"Galactic Empire\",\"Jabba Desilijic Tiure\'s criminal empire\",\"Alliance to Restore the Republic\",\"Leia Organa\'s team\",\"Endor strike team\",\"Kingdom of Han\",\"Bright Tree tribe\",\"New Republic\",\"New Republic Pilots Commission\",\"Han Solo\'s shipping company\",\"Resistance\"]','2014-12-10T16:49:14.582000Z','2014-12-20T21:17:50.334000Z',22),
	(15,'Greedo','44BBY','black','n/a','173','74','green','https://starwars.wikia.com/wiki/Greedo','https://vignette.wikia.nocookie.net/starwars/images/c/c6/Greedo.jpg','[\"Trade Federation\"]','2014-12-10T17:03:30.334000Z','2014-12-20T21:17:50.336000Z',23),
	(16,'Jabba Desilijic Tiure','600BBY','orange','n/a','175','1,358','green-tan, brown','https://starwars.wikia.com/wiki/Jabba_Desilijic_Tiure','https://vignette.wikia.nocookie.net/starwars/images/7/7f/Jabba_SWSB.png','[\"Hutt Clan\",\"Grand Hutt Council\",\"Jabba Desilijic Tiure\'s criminal empire\",\"Galactic Republic\",\"Shadow Collective\",\"Crymorah syndicate\",\"Galactic Empire\"]','2014-12-10T17:11:31.638000Z','2014-12-20T21:17:50.338000Z',24),
	(18,'Wedge Antilles','21BBY','hazel','brown','170','77','fair','https://starwars.wikia.com/wiki/Wedge_Antilles','https://static.wikia.nocookie.net/starwars/images/b/b2/WedgeAntilles-Masterwork2020.png','[\"Galactic Empire\",\"Alliance to Restore the Republic\",\"Phoenix Cell\",\"Massassi Group\",\"Red Squadron\",\"Rogue Squadron\",\"New Republic\",\"Phantom Squadron\"]','2014-12-12T11:08:06.469000Z','2014-12-20T21:17:50.341000Z',22),
	(19,'Jek Tono Porkins','unknown','blue','brown','180','110','fair','https://starwars.wikia.com/wiki/Jek_Tono_Porkins','https://vignette.wikia.nocookie.net/starwars/images/e/eb/JekPorkins-DB.png','[\"Alliance to Restore the Republic\",\"Tierfon Yellow Aces\",\"Red Squadron\",\"Massassi Group\"]','2014-12-12T11:16:56.569000Z','2014-12-20T21:17:50.343000Z',26),
	(20,'Yoda','896BBY','brown','white','66','17','green','https://starwars.wikia.com/wiki/Yoda','https://vignette.wikia.nocookie.net/starwars/images/d/d6/Yoda_SWSB.png','[\"Jedi Order\",\"Jedi High Council\",\"Galactic Republic\",\"Grand Army of the Republic\"]','2014-12-15T12:26:01.042000Z','2014-12-20T21:17:50.345000Z',28),
	(21,'Palpatine','82BBY','yellow','grey','170','75','pale','https://starwars.wikia.com/wiki/Palpatine','https://vignette.wikia.nocookie.net/starwars/images/d/d8/Emperor_Sidious.png','[\"House Palpatine\",\"Damask Holdings\",\"Royal House of Naboo\",\"Sith\",\"Order of the Sith Lords\",\"Naboo Diplomatic Corps\",\"Galactic Republic\",\"Galactic Senate\",\"Trade Federation\",\"Confederacy of Independent Systems\",\"Galactic Empire\",\"Dark Empire\"]','2014-12-15T12:48:05.971000Z','2014-12-20T21:17:50.347000Z',8),
	(22,'Boba Fett','31.5BBY','brown','black','183','78.2','fair','https://starwars.wikia.com/wiki/Boba_Fett','https://vignette.wikia.nocookie.net/starwars/images/7/79/Boba_Fett_HS_Fathead.png','[\"Confederacy of Independent Systems\",\"Boba Fett\'s syndicate\",\"Jabba Desilijic Tiure\'s criminal empire\",\"Galactic Empire\"]','2014-12-15T12:49:32.457000Z','2014-12-20T21:17:50.349000Z',10),
	(23,'IG-88','15BBY','red','none','200','140','metal','https://starwars.wikia.com/wiki/IG-88','https://vignette.wikia.nocookie.net/starwars/images/f/f2/IG-88.png','[]','2014-12-15T12:51:10.076000Z','2014-12-20T21:17:50.351000Z',28),
	(24,'Bossk','53BBY','red','none','190','113','green','https://starwars.wikia.com/wiki/Bossk','https://vignette.wikia.nocookie.net/starwars/images/1/1d/Bossk.png','[\"Bounty Hunters\' Guild\",\"Boba Fett\'s syndicate\",\"Galactic Empire\",\"Chelli Aphra\'s crew\"]','2014-12-15T12:53:49.297000Z','2014-12-20T21:17:50.355000Z',29),
	(25,'Lando Calrissian','31BBY','brown','black','177','79','dark','https://starwars.wikia.com/wiki/Lando_Calrissian','https://vignette.wikia.nocookie.net/starwars/images/8/8f/Lando_ROTJ.png','[\"Cloud City colony\",\"Galactic Empire\",\"Alliance to Restore the Republic\",\"Gold Squadron\",\"New Republic\",\"New Republic military\",\"Uprising\",\"Calrissian Enterprises\"]','2014-12-15T12:56:32.683000Z','2014-12-20T21:17:50.357000Z',30),
	(26,'Lobot','37BBY','blue','none','175','79','light','https://starwars.wikia.com/wiki/Lobot','https://static.wikia.nocookie.net/starwars/images/7/72/Lobot-SWE.png','[\"Galactic Empire\",\"Imperial Military\",\"Cloud City\",\"Alliance to Restore the Republic\",\"New Republic\"]','2014-12-15T13:01:57.178000Z','2014-12-20T21:17:50.359000Z',6),
	(27,'Ackbar','41BBY','orange','none','180','83','brown mottle','https://starwars.wikia.com/wiki/Gial_Ackbar','https://vignette.wikia.nocookie.net/starwars/images/2/29/Admiral_Ackbar_RH.png','[\"Mon Cala monarchy\",\"Mon Calamari Guard\",\"Galactic Republic\",\"Galactic Empire\",\"Alliance to Restore the Republic\",\"Alliance Fleet\",\"Alliance High Command\",\"New Republic\",\"New Republic Defense Fleet\",\"Resistance\",\"Resistance High Command\",\"Resistance Fleet Command\",\"Resistance navy\"]','2014-12-18T11:07:50.584000Z','2014-12-20T21:17:50.362000Z',31),
	(28,'Mon Mothma','48BBY','blue','auburn','150','unknown','fair','https://starwars.wikia.com/wiki/Mon_Mothma','https://static.wikia.nocookie.net/starwars/images/e/e3/MonMothma19BBY-SWE.png','[\"Galactic Republic\",\"Loyalist Committee\",\"Delegation of 2,000\",\"Galactic Empire\",\"Imperial Senate\",\"Mon Mothma\'s rebel cell\",\"Alliance to Restore the Republic\",\"New Republic\"]','2014-12-18T11:12:38.895000Z','2014-12-20T21:17:50.364000Z',32),
	(29,'Arvel Crynyd','unknown','brown','brown','unknown','unknown','fair','https://starwars.wikia.com/wiki/Arvel_Crynyd','https://vignette.wikia.nocookie.net/starwars/images/d/de/Arvel-crynyd.jpg','[\"Alliance to Restore the Republic\",\"Green Squadron\"]','2014-12-18T11:16:33.020000Z','2014-12-20T21:17:50.367000Z',28),
	(30,'Wicket Systri Warrick','8BBY','brown','brown','88','20','brown','https://starwars.wikia.com/wiki/Wicket_W._Warrick','https://vignette.wikia.nocookie.net/starwars/images/4/4f/Wicket_RotJ.png','[\"Bright Tree tribe\",\"Alliance to Restore the Republic\"]','2014-12-18T11:21:58.954000Z','2014-12-20T21:17:50.369000Z',7),
	(31,'Nien Nunb','unknown','black','none','160','68','grey','https://starwars.wikia.com/wiki/Nien_Nunb','https://vignette.wikia.nocookie.net/starwars/images/1/14/Old_nien_nunb_-_profile.png','[\"House of Organa\",\"Alliance to Restore the Republic\",\"Gold Squadron\",\"New Republic\",\"Resistance\",\"Red Squadron\"]','2014-12-18T11:26:18.541000Z','2014-12-20T21:17:50.371000Z',33),
	(32,'Qui-Gon Jinn','92BBY','blue','brown','193','89','fair','https://starwars.wikia.com/wiki/Qui-Gon_Jinn','https://vignette.wikia.nocookie.net/starwars/images/f/f6/Qui-Gon_Jinn_Headshot_TPM.jpg','[\"Jedi Order\",\"Galactic Republic\"]','2014-12-19T16:54:53.618000Z','2014-12-20T21:17:50.375000Z',28),
	(33,'Nute Gunray','unknown','red','none','191','90','mottled green','https://starwars.wikia.com/wiki/Nute_Gunray','https://vignette.wikia.nocookie.net/starwars/images/f/fd/Nute_Gunray_SWE.png','[\"Trade Federation\",\"Confederacy of Independent Systems\",\"Separatist Council\"]','2014-12-19T17:05:57.357000Z','2014-12-20T21:17:50.377000Z',18),
	(34,'Finis Valorum','91BBY','blue','blond','170','unknown','fair','https://starwars.wikia.com/wiki/Finis_Valorum','https://vignette.wikia.nocookie.net/starwars/images/5/51/ValorumPortrait-SWE.png','[\"House Valorum\",\"Galactic Republic\",\"Galactic Senate\"]','2014-12-19T17:21:45.915000Z','2014-12-20T21:17:50.379000Z',9),
	(35,'Padmé Amidala','46BBY','brown','brown','185','45','light','https://starwars.wikia.com/wiki/Padm%C3%A9_Amidala','https://vignette.wikia.nocookie.net/starwars/images/b/b2/Padmegreenscrshot.jpg','[\"Apprentice Legislators\",\"Legislative Youth Program\",\"Royal House of Naboo\",\"Galactic Republic\",\"Loyalist Committee\",\"Delegation of 2,000\",\"Galactic Empire\",\"Imperial Senate\"]','2014-12-19T17:28:26.926000Z','2014-12-20T21:17:50.381000Z',8),
	(36,'Jar Jar Binks','52BBY','orange','none','196','66','orange','https://starwars.wikia.com/wiki/Jar_Jar_Binks','https://vignette.wikia.nocookie.net/starwars/images/d/d2/Jar_Jar_aotc.jpg','[\"Gungan High Council\",\"Officer corps\",\"Galactic Republic\",\"Naboo delegation\",\"Galactic Empire\",\"Imperial Senate\"]','2014-12-19T17:29:32.489000Z','2014-12-20T21:17:50.383000Z',8),
	(37,'Roos Tarpals','unknown','orange','none','224','82','grey','https://starwars.wikia.com/wiki/Roos_Tarpals',NULL,'[\"Gungan Grand Army\"]','2014-12-19T17:32:56.741000Z','2014-12-20T21:17:50.385000Z',8),
	(38,'Rugor Nass','unknown','orange','none','206','unknown','green','https://starwars.wikia.com/wiki/Rugor_Nass',NULL,'[\"Gungan High Council\"]','2014-12-19T17:33:38.909000Z','2014-12-20T21:17:50.388000Z',8),
	(39,'Ric Olié','unknown','blue','brown','183','unknown','fair','https://starwars.wikia.com/wiki/Ric_Oli%C3%A9','https://vignette.wikia.nocookie.net/starwars/images/4/4c/RicOlieHS-SWE.png','[\"Royal House of Naboo\",\"Royal Naboo Security Forces\",\"Bravo Flight\"]','2014-12-19T17:45:01.522000Z','2014-12-20T21:17:50.392000Z',8),
	(40,'Watto','unknown','yellow','black','137','unknown','blue, grey','https://starwars.wikia.com/wiki/Watto','https://vignette.wikia.nocookie.net/starwars/images/e/eb/WattoHS.jpg','[\"Watto\'s shop\",\"Mos Espa\"]','2014-12-19T17:48:54.647000Z','2014-12-20T21:17:50.395000Z',34),
	(41,'Sebulba','unknown','orange','none','112','40','grey, red','https://starwars.wikia.com/wiki/Sebulba','https://vignette.wikia.nocookie.net/starwars/images/1/14/Sebulba_Headshot_Closeup.png','[]','2014-12-19T17:53:02.586000Z','2014-12-20T21:17:50.397000Z',35),
	(42,'Quarsh Panaka','62BBY','brown','black','183','unknown','dark','https://starwars.wikia.com/wiki/Quarsh_Panaka','https://vignette.wikia.nocookie.net/starwars/images/7/72/PanakaHS-TPM.png','[\"Royal House of Naboo\",\"Royal Naboo Security Forces\",\"Galactic Republic\",\"Republic Special Task Force\",\"Galactic Empire\"]','2014-12-19T17:55:43.348000Z','2014-12-20T21:17:50.399000Z',8),
	(43,'Shmi Skywalker','72BBY','brown','black','163','unknown','fair','https://starwars.wikia.com/wiki/Shmi_Skywalker_Lars',NULL,'[\"Skywalker family\",\"Lars family\"]','2014-12-19T17:57:41.191000Z','2014-12-20T21:17:50.401000Z',1),
	(44,'Darth Maul','54BBY','yellow','none','175','80','red','https://starwars.wikia.com/wiki/Darth_Maul','https://vignette.wikia.nocookie.net/starwars/images/5/50/Darth_Maul_profile.png','[\"Nightbrothers\",\"Sith\",\"Cad Bane\'s group\",\"Death Watch\",\"Shadow Collective\"]','2014-12-19T18:00:41.929000Z','2014-12-20T21:17:50.403000Z',36),
	(45,'Bib Fortuna','unknown','pink','none','180','unknown','pale','https://starwars.wikia.com/wiki/Bib_Fortuna','https://vignette.wikia.nocookie.net/starwars/images/3/33/BibFortunaHS-ROTJ.png','[\"Fortuna family\",\"Jabba Desilijic Tiure\'s criminal empire\"]','2014-12-20T09:47:02.512000Z','2014-12-20T21:17:50.407000Z',37),
	(46,'Ayla Secura','48BBY','hazel','none','178','55','blue','https://starwars.wikia.com/wiki/Aayla_Secura/Legends','https://vignette.wikia.nocookie.net/starwars/images/f/f9/Aayla.jpg','[\"Jedi Order\",\"Galactic Republic\"]','2014-12-20T09:48:01.172000Z','2014-12-20T21:17:50.409000Z',37),
	(47,'Ratts Tyerel','unknown','unknown','none','79','15','grey, blue','https://starwars.wikia.com/wiki/Ratts_Tyerell',NULL,'[]','2014-12-20T09:53:15.086000Z','2014-12-20T21:17:50.410000Z',38),
	(48,'Dud Bolt','unknown','yellow','none','94','45','blue, grey','https://starwars.wikia.com/wiki/Dud_Bolt','https://vignette.wikia.nocookie.net/starwars/images/7/73/Dud_Bolt_Podracer_Cockpit.png','[]','2014-12-20T09:57:31.858000Z','2014-12-20T21:17:50.414000Z',39),
	(49,'Gasgano','unknown','black','none','122','unknown','white, blue','https://starwars.wikia.com/wiki/Gasgano',NULL,'[]','2014-12-20T10:02:12.223000Z','2014-12-20T21:17:50.416000Z',40),
	(50,'Ben Quadinaros','unknown','orange','none','163','65','grey, green, yellow','https://starwars.wikia.com/wiki/Ben_Quadinaros',NULL,'[]','2014-12-20T10:08:33.777000Z','2014-12-20T21:17:50.417000Z',41),
	(51,'Mace Windu','72BBY','brown','none','188','84','dark','https://starwars.wikia.com/wiki/Mace_Windu',NULL,'[\"Jedi Order\",\"Jedi High Council\",\"Jedi assault team\",\"Mace Windu\'s squad\",\"Galactic Republic\",\"Grand Army of the Republic\"]','2014-12-20T10:12:30.846000Z','2014-12-20T21:17:50.420000Z',42),
	(52,'Ki-Adi-Mundi','92BBY','yellow','white','198','82','pale','https://starwars.wikia.com/wiki/Ki-Adi-Mundi','https://vignette.wikia.nocookie.net/starwars/images/9/9e/KiAdiMundi.jpg','[\"Jedi Order\",\"Jedi High Council\",\"Jedi assault team\",\"Galactic Republic\",\"Galactic Marines\"]','2014-12-20T10:15:32.293000Z','2014-12-20T21:17:50.422000Z',43),
	(53,'Kit Fisto','unknown','black','none','196','87','green','https://starwars.wikia.com/wiki/Kit_Fisto','https://vignette.wikia.nocookie.net/starwars/images/4/4c/Kit_Fisto_Card_Trader.png','[\"Jedi Order\",\"Jedi High Council\",\"Jedi assault team\",\"Mace Windu\'s squad\",\"Galactic Republic\"]','2014-12-20T10:18:57.202000Z','2014-12-20T21:17:50.424000Z',44),
	(54,'Eeth Koth','unknown','brown','black','171','unknown','brown','https://starwars.wikia.com/wiki/Eeth_Koth','https://vignette.wikia.nocookie.net/starwars/images/4/4e/EethKothCardTrader.png','[\"Jedi Order\",\"Jedi High Council\",\"Jedi assault team\",\"Galactic Republic\"]','2014-12-20T10:26:47.902000Z','2014-12-20T21:17:50.427000Z',45),
	(55,'Adi Gallia','unknown','blue','none','184','50','dark','https://starwars.wikia.com/wiki/Adi_Gallia',NULL,'[\"Jedi Order\",\"Jedi High Council\",\"Jedi assault team\",\"Galactic Republic\",\"Grand Army of the Republic\"]','2014-12-20T10:29:11.661000Z','2014-12-20T21:17:50.432000Z',9),
	(56,'Saesee Tiin','unknown','orange','none','188','unknown','pale','https://starwars.wikia.com/wiki/Saesee_Tiin',NULL,'[\"Jedi Order\",\"Jedi High Council\",\"Jedi assault team\",\"Galactic Republic\",\"Grand Army of the Republic\"]','2014-12-20T10:32:11.669000Z','2014-12-20T21:17:50.434000Z',47),
	(57,'Yarael Poof','unknown','yellow','none','264','unknown','white','https://starwars.wikia.com/wiki/Yarael_Poof',NULL,'[\"Jedi Order\",\"Jedi High Council\",\"Galactic Republic\"]','2014-12-20T10:34:48.725000Z','2014-12-20T21:17:50.437000Z',48),
	(58,'Plo Koon','22BBY','black','none','188','80','orange','https://starwars.wikia.com/wiki/Plo_Koon','https://vignette.wikia.nocookie.net/starwars/images/b/bf/PloKoonCardTrader.png','[\"Jedi Order\",\"Jedi High Council\",\"Jedi assault team\",\"Galactic Republic\",\"104th Battalion\"]','2014-12-20T10:49:19.859000Z','2014-12-20T21:17:50.439000Z',49),
	(59,'Mas Amedda','unknown','blue','none','196','unknown','blue','https://starwars.wikia.com/wiki/Mas_Amedda','https://vignette.wikia.nocookie.net/starwars/images/3/37/Mas_Amedda_SWCT.png','[\"Galactic Republic\",\"Galactic Senate\",\"Office of the Chancellor\",\"Strategic Advisory Cell\",\"Galactic Empire\",\"Imperial Ruling Council\",\"Coruscant provisional government\"]','2014-12-20T10:53:26.457000Z','2014-12-20T21:17:50.442000Z',50),
	(60,'Gregar Typho','unknown','brown','black','185','85','dark','https://starwars.wikia.com/wiki/Gregar_Typho','https://vignette.wikia.nocookie.net/starwars/images/5/52/Gregar_Typho.jpg','[\"Royal House of Naboo\",\"Royal Naboo Security Forces\",\"Galactic Republic\"]','2014-12-20T11:10:10.381000Z','2014-12-20T21:17:50.445000Z',8),
	(61,'Cordé','unknown','brown','brown','157','unknown','light','https://starwars.wikia.com/wiki/Cord%C3%A9',NULL,'[\"Royal House of Naboo\",\"Naboo Royal Handmaidens\",\"Galactic Republic\"]','2014-12-20T11:11:39.630000Z','2014-12-20T21:17:50.449000Z',8),
	(62,'Cliegg Lars','82BBY','blue','brown','183','unknown','fair','https://starwars.wikia.com/wiki/Cliegg_Lars','https://vignette.wikia.nocookie.net/starwars/images/3/36/ClieggLarsHS-SWE.jpg','[\"Lars family\"]','2014-12-20T15:59:03.958000Z','2014-12-20T21:17:50.451000Z',1),
	(63,'Poggle the Lesser','unknown','yellow','none','183','80','green','https://starwars.wikia.com/wiki/Poggle_the_Lesser','https://vignette.wikia.nocookie.net/starwars/images/9/93/Poggle_the_lesser_-_sw_card_trader.png','[\"Stalgasin hive\",\"Karina the Great\'s empire\",\"Techno Union\",\"Confederacy of Independent Systems\",\"Separatist Council\",\"Galactic Republic\"]','2014-12-20T16:40:43.977000Z','2014-12-20T21:17:50.453000Z',11),
	(64,'Luminara Unduli','58BBY','blue','black','170','56.2','yellow','https://starwars.wikia.com/wiki/Luminara_Unduli',NULL,'[\"Jedi Order\",\"Jedi assault team\",\"Galactic Republic\",\"41st Elite Corps\"]','2014-12-20T16:45:53.668000Z','2014-12-20T21:17:50.455000Z',51),
	(65,'Barriss Offee','40BBY','blue','black','166','50','yellow','https://starwars.wikia.com/wiki/Barriss_Offee','https://vignette.wikia.nocookie.net/starwars/images/3/37/Barrisprofile2.jpg','[\"Jedi Order\",\"Jedi assault team\",\"Galactic Republic\",\"Grand Army of the Republic\"]','2014-12-20T16:46:40.440000Z','2014-12-20T21:17:50.457000Z',51),
	(66,'Dormé','unknown','brown','brown','165','unknown','light','https://starwars.wikia.com/wiki/Dorm%C3%A9',NULL,'[\"Royal House of Naboo\",\"Naboo Royal Handmaidens\",\"Galactic Republic\"]','2014-12-20T16:49:14.640000Z','2014-12-20T21:17:50.460000Z',8),
	(67,'Dooku','102BBY','brown','white','193','80','fair','https://starwars.wikia.com/wiki/Dooku','https://vignette.wikia.nocookie.net/starwars/images/b/b8/Dooku_Headshot.jpg','[\"House of Dooku\",\"Lost Twenty\",\"Sith\",\"Independent Movement for Self-Determination\",\"Confederacy of Independent Systems\"]','2014-12-20T16:52:14.726000Z','2014-12-20T21:17:50.462000Z',52),
	(68,'Bail Prestor Organa','67BBY','brown','black','191','unknown','tan','https://starwars.wikia.com/wiki/Bail_Prestor_Organa','https://vignette.wikia.nocookie.net/starwars/images/5/50/Bail_Organa_Mug.jpg','[\"House of Organa\",\"High Court of Alderaan\",\"Galactic Republic\",\"Galactic Senate\",\"Loyalist Committee\",\"Security Committee\",\"Delegation of 2000\",\"Galactic Empire\",\"Imperial Senate\",\"Finance Committee\",\"Appropriations Committee\",\"Intelligence Oversight Committee\",\"Military Oversight Committee\",\"Alderaanian Resistance\",\"Kota\'s Militia\",\"Alliance to Restore the Republic\"]','2014-12-20T16:53:08.575000Z','2014-12-20T21:17:50.463000Z',2),
	(69,'Jango Fett','66BBY','brown','black','183','79','tan','https://starwars.wikia.com/wiki/Jango_Fett','https://vignette.wikia.nocookie.net/starwars/images/5/56/JangoInfobox.png','[\"Confederacy of Independent Systems\",\"Tyranus\"]','2014-12-20T16:54:41.620000Z','2014-12-20T21:17:50.465000Z',53),
	(70,'Zam Wesell','unknown','yellow','blonde','168','55','fair, green, yellow','https://starwars.wikia.com/wiki/Zam_Wesell','https://vignette.wikia.nocookie.net/starwars/images/7/7d/Clawdite.jpg','[\"Mabari\",\"Confederacy of Independent Systems\"]','2014-12-20T16:57:44.471000Z','2014-12-20T21:17:50.468000Z',54),
	(71,'Dexter Jettster','unknown','yellow','none','198','102','brown','https://starwars.wikia.com/wiki/Dexter_Jettster',NULL,'[\"Dex\'s Diner\"]','2014-12-20T17:28:27.248000Z','2014-12-20T21:17:50.470000Z',55),
	(72,'Lama Su','unknown','black','none','229','88','grey','https://starwars.wikia.com/wiki/Lama_Su','https://vignette.wikia.nocookie.net/starwars/images/7/73/Lama_Su.jpg','[\"Galactic Republic\"]','2014-12-20T17:30:50.416000Z','2014-12-20T21:17:50.473000Z',10),
	(73,'Taun We','unknown','black','none','213','unknown','grey','https://starwars.wikia.com/wiki/Taun_We','https://vignette.wikia.nocookie.net/starwars/images/9/9c/TaunWe.jpg','[\"Galactic Republic\"]','2014-12-20T17:31:21.195000Z','2014-12-20T21:17:50.474000Z',10),
	(74,'Jocasta Nu','unknown','blue','white','167','unknown','fair','https://starwars.wikia.com/wiki/Jocasta_Nu','https://vignette.wikia.nocookie.net/starwars/images/1/15/Jocasta_Nu_SWE.png','[\"Jedi Order\",\"Jedi High Council\"]','2014-12-20T17:32:51.996000Z','2014-12-20T21:17:50.476000Z',9),
	(75,'R4-P17','unknown','red, blue','none','96','unknown','silver, red','https://starwars.wikia.com/wiki/R4-P17','https://vignette.wikia.nocookie.net/starwars/images/6/6b/R4-P17.jpg','[\"Galactic Republic\"]','2014-12-20T17:43:36.409000Z','2014-12-20T21:17:50.478000Z',28),
	(76,'Wat Tambor','unknown','unknown','none','193','48','green, grey','https://starwars.wikia.com/wiki/Wat_Tambor','https://vignette.wikia.nocookie.net/starwars/images/a/a5/Wat_Tambor.png','[\"Techno Union\",\"Baktoid Armor Workshop\",\"Confederacy of Independent Systems\",\"Separatist Council\"]','2014-12-20T17:53:52.607000Z','2014-12-20T21:17:50.481000Z',56),
	(77,'San Hill','unknown','gold','none','191','unknown','grey','https://starwars.wikia.com/wiki/San_Hill',NULL,'[\"InterGalactic Banking Clan\",\"Muunilinst Banking Clan\",\"Confederacy of Independent Systems\",\"Separatist Council\"]','2014-12-20T17:58:17.049000Z','2014-12-20T21:17:50.484000Z',57),
	(78,'Shaak Ti','unknown','black','none','178','57','red, blue, white','https://starwars.wikia.com/wiki/Shaak_Ti','https://vignette.wikia.nocookie.net/starwars/images/2/20/Shaak_Ti_closeup-SWE.png','[\"Jedi Order\",\"Jedi High Council\",\"Jedi assault team\",\"Galactic Republic\",\"Grand Army of the Republic\"]','2014-12-20T18:44:01.103000Z','2014-12-20T21:17:50.486000Z',58),
	(79,'Grievous','unknown','green, yellow','none','216','159','brown, white','https://starwars.wikia.com/wiki/Grievous',NULL,'[\"Confederacy of Independent Systems\",\"Separatist Droid Army\"]','2014-12-20T19:43:53.348000Z','2014-12-20T21:17:50.488000Z',59),
	(80,'Tarfful','unknown','blue','brown','234','136','brown','https://starwars.wikia.com/wiki/Tarfful','https://vignette.wikia.nocookie.net/starwars/images/3/37/Tarfful_RotS.png','[\"Galactic Republic\"]','2014-12-20T19:46:34.209000Z','2014-12-20T21:17:50.491000Z',14),
	(81,'Raymus Antilles','unknown','brown','brown','188','79','light','https://starwars.wikia.com/wiki/Raymus_Antilles','https://vignette.wikia.nocookie.net/starwars/images/8/80/Raymus_card_trader.png','[\"House of Organa\",\"Alliance to Restore the Republic\",\"Alliance Military\"]','2014-12-20T19:49:35.583000Z','2014-12-20T21:17:50.493000Z',2),
	(82,'Sly Moore','unknown','white','none','178','48','pale','https://starwars.wikia.com/wiki/Sly_Moore',NULL,'[\"Galactic Republic\",\"Office of the Chancellor\",\"Galactic Empire\"]','2014-12-20T20:18:37.619000Z','2014-12-20T21:17:50.496000Z',60),
	(83,'Tion Medon','unknown','black','none','206','80','grey','https://starwars.wikia.com/wiki/Tion_Medon',NULL,'[\"Galactic Republic\"]','2014-12-20T20:35:04.260000Z','2014-12-20T21:17:50.498000Z',12);

/*!40000 ALTER TABLE `people` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table person_species
# ------------------------------------------------------------
...
INSERT INTO `person_species` (`id`, `person_id`, `species_id`)
VALUES
	(1,2,2),
	(2,3,2),
	(3,8,2),
...
INSERT INTO `person_starship` (`id`, `person_id`, `starship_id`)
VALUES
	(1,1,12),
	(2,1,22),
	(3,4,13),
...
INSERT INTO `person_vehicle` (`id`, `person_id`, `vehicle_id`)
VALUES
	(1,1,14),
	(2,1,30),
	(3,5,30),
...
INSERT INTO `planets` (`id`, `name`, `rotation_period`, `orbital_period`, `diameter`, `climate`, `gravity`, `terrain`, `surface_water`, `population`, `created`, `edited`)
VALUES
...
CREATE TABLE `species` (
  ...
  `average_height` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `average_lifespan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `eye_colors` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `hair_colors` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `skin_colors` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `species` (`id`, `name`, `classification`, `designation`, `average_height`, `average_lifespan`, `eye_colors`, `hair_colors`, `skin_colors`, `language`, `created`, `edited`, `homeworld_id`)
VALUES
...
CREATE TABLE `starships` (
  ...
  `starship_class` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `manufacturer` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cost_in_credits` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `max_atmosphering_speed` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `hyperdrive_rating` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `MGLT` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cargo_capacity` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `consumables` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `edited` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `starships` (`id`, `name`, `model`, `starship_class`, `manufacturer`, `cost_in_credits`, `length`, `crew`, `passengers`, `max_atmosphering_speed`, `hyperdrive_rating`, `MGLT`, `cargo_capacity`, `consumables`, `created`, `edited`)
VALUES
...
INSERT INTO `vehicles` (`id`, `name`, `model`, `vehicle_class`, `manufacturer`, `length`, `cost_in_credits`, `crew`, `passengers`, `max_atmosphering_speed`, `cargo_capacity`, `consumables`, `created`, `edited`)
VALUES
